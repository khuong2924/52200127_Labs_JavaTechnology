...
//			studentRepository.findAll().forEach(System.out::println);
			...
			List<Student> std_findByAge = studentRepository.findByAgeGreaterThanEqual(21);
			...
			List<Student> std_findByScore = studentRepository.findByIeltsScoreEquals(7.0);
			...
			List<Student> std_findByName = studentRepository.findByNameContainingIgnoreCase("Khuong");
